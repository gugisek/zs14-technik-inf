...
export default function Abilities_a({}: Props) {
    ...
    const abilities = [
        ...
        desc: 'Nauczysz się tworzenia interfejsów użytkownika, <span style="color: #31939c">projektowania stron</span> oraz wdrażaniu funkcjonalności i odpowiednich technologii.',
        img: '/sala.png',
        imgHover: '/tablica.jpg',
        option: 'right'},

        {title: 'ADMINISTROWANIE SYSTEMAMI',
        desc: 'Będziesz mógł konfigurować oraz zarządzać infrastrukturą IT, podstawy linux oraz windows serwer nie będą Ci obce.',
        img: '/sala.png',
        imgHover: '/tablica.jpg',
        option: 'left'},
