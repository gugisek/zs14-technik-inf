...
export default function Absolwents_post({name, where, direction, option}: Props) {
  return (
    ...
    initial={{opacity: 0, x: 200}}
        ...
        whileTap={{ scale: 0.9 }}
        className={`flex lg:flex-row flex-col lg:w-3/5 w-[90%] px-10 py-7 justify-between items-center bg-white drop-shadow-[0_35px_35px_rgba(0,0,0,0.3)] lg:rounded-[57px] rounded-[57px]`}>
            <div>
