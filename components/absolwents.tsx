...
export default function Absolwents({}: Props) {
  return (
    ...
    className='bg-[#E6EDDF] lg:w-3/5 w-[90%] lg:rounded-[97px] rounded-[57px] lg:px-32 px-10 lg:py-24 py-16 leading-tight flex lg:flex-row flex-col-reverse justify-center items-center my-0 gap-10 mt-[300px]' id='scrolled'>
